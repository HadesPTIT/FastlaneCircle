...
public class SwipeController extends Callback {
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder, int index) {
        ...
        if (index == 1) {
            ...
            drawText("Add Playlis", c, leftButton, p);
            ...
            drawText("Add Playlis", c, rightButton, p);
            if (buttonShowedState == ButtonsState.LEFT_VISIBLE) {
    ...
    public void onDraw(Canvas c, int index) {
        if (currentItemViewHolder != null) {
            drawButtons(c, currentItemViewHolder, index);
        }
    }
}
