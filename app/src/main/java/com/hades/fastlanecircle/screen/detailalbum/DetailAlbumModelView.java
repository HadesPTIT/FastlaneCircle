...
import com.hades.fastlanecircle.screen.addtracktoalbum.AddTrackActivity;
import com.hades.fastlanecircle.screen.moretrack.Calback;
import com.hades.fastlanecircle.screen.moretrack.MoreTrackPlayListFragment;
...
//        popupMenu.show();
    ...
    public void deleteTrack(int position) {
        boolean resultRemoveTrack = AlbumRepository.getInstance(mContext)
                .removeTrack(mIdAlbum, mTracks.get(position));
        onRemoveTrack(resultRemoveTrack);
    }
