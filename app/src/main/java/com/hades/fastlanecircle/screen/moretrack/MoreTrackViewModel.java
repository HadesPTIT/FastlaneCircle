...
import com.hades.fastlanecircle.data.source.remote.TrackDownloadManager;
...
public class MoreTrackViewModel extends BaseObservable {
    ...
    private com.hades.fastlanecircle.screen.moretrack.Calback mCalback;
    ...
    public void setCalback(com.hades.fastlanecircle.screen.moretrack.Calback calback) {
        mCalback = calback;
    }
