...
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_ALL;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_CLASSIC;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_COUNTRY;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_DEEP_HOUSE;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_EDM;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_ELECTRONIC;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_POP;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_POP_BLAS;
import static com.hades.fastlanecircle.data.source.repository.GenresRepository.ServiceName.GENRES_ROCK;
