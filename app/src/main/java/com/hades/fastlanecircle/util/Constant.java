package com.hades.fastlanecircle.util;
...
public class Constant {
    ...
    public static final String ACTION_MAIN = "com.hades.fastlanecircle.action.main";
    public static final String ACTION_PREV = "com.hades.fastlanecircle.action.action.prev";
    public static final String ACTION_PLAY = "com.hades.fastlanecircle.action.action.play";
    public static final String ACTION_NEXT = "com.hades.fastlanecircle.action.action.next";
    public static final String ACTION_DISMIS = "com.hades.fastlanecircle.action.action.dismis";
    public static final String ACTION_NOTIFI_CHANGE =
            "com.hades.fastlanecircle.action.action.change";
